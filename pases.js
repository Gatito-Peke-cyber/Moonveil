...
const MISSIONS_TEMPLATE = [
  ...
  { id:'game_flowers',  name:'Cosecha de Flores',       desc:'Recoge 10 flores silvestres en el mundo.',emoji:'🌸', reset:'24h', xpReward:100, reward:{ type:'emeralds', amount:2 }, target:10,  exclusive:null, category:'Misiones de Juego', categoryIcon:'🎮', isGame:true, preCompleted:true },
