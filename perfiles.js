...
const VILLAGERS = [
  {
    ...
    job: '█████████',
    img: 'vill/vill1.jpg',
    booksRelated: ['Ubik – Philip K. Dick', 'House of Leaves – Mark Z. Danielewski'],
    booksRead: ['I Know Where She Is', 'A Night in the Lonesome October', 'Evil Never Dies', 'A Sinister Obsession', 'Touching Incidents and Remarkable Answers to Prayer'],
    hobbies: ['Caminar','Leer','Tradear'],
