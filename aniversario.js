...
/* ----------------------------
   ...
   ---------------------------- */
// Usa un prefijo distinto según la sección
const EVENT_PREFIX = "anniv2025_"; // 👈 prefijo único para este evento

const LS_KEYS = {
  CONFETTI: EVENT_PREFIX + 'confetti_seen',
  PROGRESS: EVENT_PREFIX + 'progress',
  MISSIONS: EVENT_PREFIX + 'missions',
  SHOP: EVENT_PREFIX + 'shop',
  BADGES: EVENT_PREFIX + 'badges',
  VILLAGER_LIKES: EVENT_PREFIX + 'vlikes',
  LAST_VISIT: EVENT_PREFIX + 'last_visit',
};
...
/* ----------------------------
   ...
   ---------------------------- */
const SITE_START = '2022-09-23T00:00:00Z'; // ejemplo: inicio del sitio
const NOW = ()=> new Date();
...
/* ----------------------------
   ...
   ---------------------------- */
const MISSIONS_DEF = [
  {id:'m_daily_1', title:'Recolecta flores', desc:'Reúne 10 flores del campo', xp:10, cooldown: DAYS(1)},
  {id:'m_daily_2', title:'Tradeador', desc:'Tradea 3 veces', xp:15, cooldown: DAYS(1)},
  {id:'m_daily_3', title:'Tradeador EZ', desc:'Tradea 12 veces', xp:45, cooldown: DAYS(1)},
  {id:'m_daily_4', title:'Last Soul', desc:'Compra en la pagina (1 vez)', xp:30, cooldown: DAYS(1)},
  {id:'m_daily_5', title:'Last Soul EZ', desc:'Compra en la pagina (5 veces)', xp:100, cooldown: DAYS(1)},
  {id:'m_daily_6', title:'Free!!', desc:'Recoge lo gratis de la tienda', xp:30, cooldown: DAYS(1)},
  {id:'m_daily_7', title:'Money?', desc:'Gasta 20 de cobre', xp:30, cooldown: DAYS(1)},
  {id:'m_week_1', title:'Tradeador EX', desc:'Tradea 40 veces', xp:80, cooldown: DAYS(7)},
  {id:'m_week_2', title:'Last Soul X', desc:'Compra en la pagina (10 veces)', xp:200, cooldown: DAYS(7)},
  {id:'m_week_3', title:'Money 2?', desc:'Gasta 60 de Cobre', xp:80, cooldown: DAYS(7)},
  {id:'m_week_4', title:'Eating!?', desc:'Obten comida de aldeanos tradeando (4 veces)', xp:100, cooldown: DAYS(7)},
  {id:'m_month_1', title:'Dogs!?', desc:'█████████ 2 gatos diferentes', xp:100, cooldown: DAYS(30)},
  {id:'m_month_2', title:'Master Trader', desc:'Lleva a 3 aldeanos a nivel maximo', xp:200, cooldown: DAYS(30)},
  {id:'m_month_3', title:'█████████', desc:'Busca el █████ en el piso I', xp:200, cooldown: DAYS(30)},
];
...
/* ----------------------------
   ...
   ---------------------------- */
const SHOP_DEF = [
  {id:'s_confetti_pack', name:'Caja de █████████', desc:'Esta caja fue dejada por █████████ y ahora es toda tuya.¡Sera!', price:500, stock:1, restock: DAYS(1), discount:25},
  {id:'s_confetti_pack2', name:'Ticket de Descuento', desc:'Ticket de un Descuetno Unico del 100%', price:500, stock:5, restock: DAYS(365), discount:75},
  {id:'s_golden_badge', name:'Insignia', desc:'Insignia 3 Años (decorativa)', price:200, stock:2, restock: DAYS(365)},
  {id:'s_mystery_box', name:'Llave Aniv.(x1)', desc:'Llaves de la Suerte', price:10, stock:10, restock: DAYS(1)},
  {id:'s_mystery_box2', name:'Llave Aniv.(x1)', desc:'Llaves de la Suerte ¡Tiene Descuento!', price:10, stock:10, restock: DAYS(7), discount:75},
  {id:'s_mystery_box3', name:'Llave Aniv.(x2)', desc:'Llaves de la Suerte', price:10, stock:3, restock: DAYS(1)},
  {id:'s_mystery_box4', name:'Llave Aniv.(x10)', desc:'Pack de Llaves de la Suerte ¡Tiene Descuento!', price:100, stock:1, restock: DAYS(7), discount:25},
  {id:'s_mystery_box5', name:'Monedas', desc:'Monedas Gratuitas', price:100, stock:1, restock: DAYS(1), discount:100},
  {id:'s_banner', name:'B. Aniversario', desc:'Banner conmemorativo, tambien lo puedes conseguir ¡Gratis! con las llaves.', price:300, stock:1, restock: DAYS(365)},
];
...
const BADGES_DEF = [
  ...
  //{
    //id:'b_sept24',
    //name:'Aniversario 27Sep25',
    //desc:'Entraste el 27 de Septiembre de 2025',
    //icon:'fa-solid fa-cake-candles', // 🎂 pastel de aniversario
    //tier:'legendary',
    //check: prog => prog.visitedOn.includes("2025-09-27")
  //},
  {
    id:'b_sept27',
    name:'Aniversario',
  ...
  {
  id:'b_20likes',
  name:'Aldeano Popular',
  desc:'Alcanza 20 likes en total de los aldeanos',
...
/* ----------------------------
   ...
   ---------------------------- */
const NEWS_ANN = [
  {id:'na1', title:'Evento de lanzamiento', text:'¡Comienza el Aniversario!'},
  {id:'na2', title:'Descuento de tienda', text:'Se tiene descuentos en la tienda.'},
  {id:'na3', title:'Misiones', text:'Misiones diarias, semanales y mensuales.'},
  {id:'na4', title:'Events!', text:'Eventos de Aniversario.'},
  {id:'na5', title:'Villager?', text:'Find?'},
  {id:'na6', title:'Free!!', text:'Todos los dias monedas gratis.'},
  {id:'na7', title:'x2', text:'La primera llave que compres te llevas un (+1).'},
  {id:'na8', title:'100%', text:'Obtienes un 100% en la primera compra de un objeto de la "TIENDA" que tenga un valor de 100 a menos.'},
  {id:'na9', title:'Diaries!?', text:'Un objeto FREE.'},
  {id:'na10', title:'???', text:'█████████'},
];

const VILLAGER_MSGS_DEF = [
  {id:'v1', name:'Sand Brill', photo:'', text:'¡Feliz aniversario! Que haya muchas minas y pan.'},
  {id:'v2', name:'Mira', photo:'', text:'Brindo por los mapas descubiertos. ¡Felicidades!'},
  {id:'v3', name:'Sev Ark', photo:'', text:'Sigamos explorando más secretos. Feliz aniversario.¡Eso espero...!'},
  {id:'v5', name:'Sand Brill', photo:'', text:'Ya felicite, no me acuerdo...'},
  {id:'v6', name:'Sand Brill', photo:'', text:'Pero si no fue asi, ummm...'},
  {id:'v7', name:'Sand Brill', photo:'', text:'¡FELIZ ANIVERSARIO A MOONVEIL!'},
  {id:'v8', name:'Sev Ark', photo:'', text:'Si ya felicitaste, ahora ya no comentes nada mas, Sand!!'},
  {id:'v9', name:'Brun Tallow', photo:'', text:'¡Felicidades! Yey!!, bueno dejando eso ustedes dos son muy molestos, Sand y Sev.'},
  {id:'v9', name:'Brun Tallow', photo:'', text:'Y de donde salio ¿Mira?, no conozco alguien llamado asi...'},
  {id:'v10', name:'Sand Brill', photo:'', text:'¿Molesto yo?, Excuse me!'},
  {id:'v11', name:'Sand Brill', photo:'', text:'¿Pero cierto de donde salio Mira? No conozco alguien llamado asi... ¿Sera?'},
  {id:'v12', name:'Sand Brill', photo:'', text:'Un espia aldeanil...'},
  {id:'v13', name:'Mira', photo:'', text:'Como que no existo!... Acaso me estan difamando, si existo, vale!'},
  {id:'v14', name:'Sev Ark', photo:'', text:'No existes, en los perfiles no existes, asi que quien podrias ser...'},
  {id:'v15', name:'Sand Brill', photo:'', text:'Asi! No sabia de ello, asi que es un vaca espia'},
  {id:'v16', name:'Sev Ark', photo:'', text:'No dire nada, de verdad Sand, te haces o eres un nitwit'},
  {id:'v17', name:'Sand Brill', photo:'', text:'A quien llamas nitwit, me ofendi en formato png'},
  {id:'v18', name:'Brun Tallow', photo:'', text:'Pero dejando sus estos, en si no existe, quien seras...'},
  {id:'v19', name:'Mira', photo:'', text:'Hay de verdad que si son detectives, bueno si o no, ¿Quien sabe?'},
  {id:'v20', name:'Sand Brill', photo:'', text:'Pero no tengo sombrero!!'},
  {id:'v21', name:'Sev Ark', photo:'', text:'Sin comentarios a lo de Sand'},
  {id:'v22', name:'█████████', photo:'', text:'Hay una caja que estan vendiendo, si fuera tu... No la compraria, y ¡Feliz Aniversario!'},
  {id:'v23', name:'Sand Brill', photo:'', text:'Y este, de donde saliste, mi diario es una caja... No te atrevas a leerlo.'},
  {id:'v24', name:'█████████', photo:'', text:'Mucho hablan, asi que se cerrara.'},
];
...
function addXP(amount){
  ...
  while (lvl < 20 && PROG.xp >= xpForLevel(lvl+1)) {
    lvl++;
  }
  PROG.level = lvl;
  lsSave(LS_KEYS.PROGRESS, PROG);
